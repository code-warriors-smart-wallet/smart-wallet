...
// // Get current budget period entry - now works with single entry for all spaces
...
// // Get budget entries for a budget - now works with single entry per period
...
//         if (existingBudget.type === "ONE_TIME") {
//             // FIXED: Update the budget amount
...
// // CHANGED: Get budget spending with entries - now aggregates across all spaces
