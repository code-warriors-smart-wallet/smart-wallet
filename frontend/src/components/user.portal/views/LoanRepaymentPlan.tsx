                                ...
                                installments.map(installment => {
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className="px-2 py-3 border-b border-border-light-primary dark:border-border-dark-primary text-text-light-primary dark:text-text-dark-primary">{(installment.principalAmount + installment.interestAmount).toFixed(2)}</td>
