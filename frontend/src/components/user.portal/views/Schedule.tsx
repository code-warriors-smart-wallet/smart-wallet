...
function Schedule() {
   ...
   // Check if current space is a loan space and return early
   if (spacetype && (toStrdSpaceType(spacetype) === SpaceType.LOAN_LENT || 
       toStrdSpaceType(spacetype) === SpaceType.LOAN_BORROWED)) {
       return (
           <div className="text-center py-10">
               <h2 className="text-xl text-text-light-primary dark:text-text-dark-primary">
                   Schedules are not available for loan spaces
               </h2>
               <p className="text-text-light-secondary dark:text-text-dark-secondary mt-2">
                   Please use the loan repayment plan feature to manage your loan installments.
               </p>
           </div>
       );
   }
