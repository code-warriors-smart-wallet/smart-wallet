...
function Register() {
    ...
    const { register, loginWithGoogle, loginWithFacebook } = AuthService();
    ...
    const onGoogleLogin = useGoogleLogin({
        onSuccess: async (tokenResponse: any) => {
            ...
            navigate("/register/currency", { state: { token: tokenResponse.access_token, type: 'google' } })
        },
    ...
    const onFacebookLogin = () => {
        ...
        window.FB.login((response: any) => {
            if (response.authResponse) {
                ...
                navigate("/register/currency", { state: { token: accessToken, type: 'facebook' } });
            } else {
