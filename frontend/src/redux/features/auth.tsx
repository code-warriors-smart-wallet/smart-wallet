...
const authSlice = createSlice({
    ...
    reducers: {
        ...
        updateUser(state, action: { payload: Partial<AuthState> }) {
...
export const { loginSuccess, logout, setEmail, setUsername, setIsAuthenticated, setToken, setSpaces, setOTPAttemptsRemaining, setCurrency, setTheme, updateUser } = authSlice.actions;
