    ...
    async function login(body: LoginInfo, redirect?: string) {
        try {
            ...
            if (response.data.success) {
                ...
                const accessToken = response.data.data.object.accessToken;
                ...
                console.log("User data with userId:", userData); // Debug log
                dispatch(loginSuccess(userData))
                console.log(response.data.data.object.spaces)
                toast.success("Login successful!");
                if (redirect) {
    ...
    async function loginWithGoogle(body: {token: string, currency?: string}, redirect: string) {
        try {
            ...
            if (response.data.success) {
                ...
                console.log("Extracted userId from Google token:", userId); // Debug log
                ...
                console.log("Google login user data with userId:", userData); // Debug log
                dispatch(loginSuccess(userData))
                toast.success("Login successful!");
                if (redirect) {
                    navigate(redirect);
